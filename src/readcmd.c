...
char *readline(char *prompt)
{
	...
	do {
		//compte pas le car null de fin
		size_t l = strlen(buf);
		//si == \n on est arrivé à la fin de la cmd. il reste plus qu'a l'executer
		if ((l > 0) && (buf[l-1] == '\n')) {
		//transforme retour chariot en fin d chaine de car
